...
$output .= '<div id="wpsl-wrap" class="zenmap-container">' . "\r\n";
$output .= "\t" . '<div class="wpsl-search wpsl-clearfix zenleaf-searchtools ' . $this->get_css_classes() . '">' . "\r\n";
...
$output .= "\t\t\t\t" . '<div><button class="custom-reset-button">Reset Map</button></div>' . "\r\n";

if ( $this->use_category_filter() ) {
    $output .= $this->create_category_filter();
    $output .= "\t\t\t\t" . '<div class="wpsl-icon-direction"><span>&#xe800;</span></div>';
//    $output .= "\t\t\t\t\t" . '<div id="wpsl-checkbox-filter" class="">';
//    $output .= "\t\t\t\t\t" . '<div class="">';
//    $output .= "\t\t\t\t\t\t" . '<label for="medical">Medical</label>';
//    $output .= "\t\t\t\t\t\t" . '<input type="checkbox" name="medical" id="medical" value="69">';
//    $output .= "\t\t\t\t\t" .'</div>';
//    $output .= "\t\t\t\t\t" . '<div class="">';
//    $output .= "\t\t\t\t\t\t" . '<label for="recreational">Recreational</label>';
//    $output .= "\t\t\t\t\t\t" . '<input type="checkbox" name="recreational" id="recreational" value="70">';
//    $output .= "\t\t\t\t\t" .'</div>';
//    $output .= "\t\t\t\t\t" .'</div>';
}
