...
/**
 * Template Name: Get a Card Help - Connecticut
 *
 * @package WordPress
...
<div class="w-full bg-gray-100 text-black">
    <div class="max-w-5xl mx-auto py-6 px-4">    
        <h1 class="text-3xl font-subheading normal-case text-center leading-normal" style="line-height:1.2em;">Get Help Becoming a <span class="block lg:inline">Connecticut</span> <span class="block lg:inline">Medical Cannabis Patient</span></h1>
        <p class="text-lg lg:text-xl  mb-3 text-center mx-auto max-w-md lg:max-w-none" >Wondering how to get your medical cannabis card in Connecticut? <span class="lg:block">Curious as to what the qualifying conditions, purchase limits, and fees are?</span>
</p>
    ...
    <div class="p-8 mx-auto border border-gray-500 w-full max-w-2xl rounded ">
        ...
        <div class="grid lg:grid-cols-2 gap-4">
            ...
            <div class="mb-2">
                ...
                <div class="mb-2">
                    <div class="mt-1 mb-2">
                    <input type="hidden" id="state" name="state" value="CT" >
                        ...
                        <select name="location" id="location" class="block w-full pl-3 pr-10 py-2 text-base border-gray-500 focus:outline-none focus:ring-black focus:border-black sm:text-sm rounded-md" style="border:1px solid #747474; font-size:18px; color:black;" required>
                            <option value=""  class="text-grey-800 text-base py-2" disabled selected>-- Please choose an option --</option>
                            <option value="CT002" class="text-black text-base py-2">Caring Nature</option>
                            <option value="CT001" class="text-black text-base py-2">Willowbrook Wellness</option>
