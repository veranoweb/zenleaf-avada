...
<div class="w-full bg-gray-100 text-black">
    <div class="max-w-5xl mx-auto py-6 px-4">    
        <h1 class="text-xl font-subheading normal-case text-center leading-normal" style="line-height:1.2em;">Get Help Becoming a <span class="block lg:inline">Pennsylvania</span> <span class="block lg:inline">Medical Marijuana Patient</span></h1>
        <p class="text-base  mb-3 text-center mx-auto max-w-md lg:max-w-none" >Wondering how to get your medical marijuana card in Pennsylvania? <span class="lg:block">Curious as to what the qualifying conditions, purchase limits, and fees are?</span>
</p>
