        ...
        <div class="relative flex items-center justify-between h-16">
            ...
            <div class="flex-1 flex items-center justify-center lg:items-stretch lg:justify-start">
                ...
                <a class="flex-shrink-0 flex items-center" href="/">
                    <img class=" md:h-10 w-auto lg:mt-1 hidden md:block" style="max-width:50vw" src="/wp-content/uploads/2022/01/zen-leaf-logo-with-text-67h.svg" alt="Zen Leaf Dispensaries">
                    <img class="h-10  w-auto md:hidden" style="max-width:50vw" src="/wp-content/uploads/2022/01/zen-leaf-logo-67h.svg" alt="Zen Leaf Dispensaries">
                </a>
                <!-- Desktop Menu -->
            ...
            <div class="absolute inset-y-0 right-0 flex items-center pr-2">
                <div class="relative">
                    <div class="flex space-x-4 ml-4">
                        ...
                        <!-- Shop Button -->
                        <div class="dropdown">
                            <button class="bg-black hover:bg-white ring-gray-700 border-solid border-2 border-black hover:text-black text-sm py-2 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white text-white px-4 sm:px-8 uppercase inline-flex items-center rounded-md tracking-widest sm:text-base lg:mt-2 font-bold group"
